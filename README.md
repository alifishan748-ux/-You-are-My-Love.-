...
<head>
    ...
    <script>
        ...
        let quizAnswers = [];
        const questions = [
            "What word best describes the magic we share?",
            "What's your favorite memory that shows how perfect we are together?",
            "How do you imagine our happily ever after?"
        ];
...
<body>
    ...
    <div class="container">
        ...
        <div class="quiz">
            <div class="question">What word best describes the magic we share?</div>
            <div class="options">
                <button onclick="nextQuestion('Eternal')">Eternal</button>
                <button onclick="nextQuestion('Passionate')">Passionate</button>
                <button onclick="nextQuestion('Unforgettable')">Unforgettable</button>
            </div>
        </div>
        <div class="buttons">
